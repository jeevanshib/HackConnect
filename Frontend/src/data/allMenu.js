export const menu = [
    { 
      ...
      icon: "campus",
      description: 
        "Unique, exclusive space for college students on HackConnect.",
    },
    {
      name: "Events", 
      icon: "events", 
    ...
    },
    {
      ...
      icon: "pages",
      description: 
        "Discover and connect with businesses on HackConnect."
    },
    {
      name: "Gaming Video", 
      icon: "gaming", 
    ...
    },
    {
      ...
      icon: "recent", 
      description: 
        "See all the apps you interacted with on Socioconnect."
    },
    {
      name: "Memories",
      icon: "memories", 
      description: 
        "Browse your old photos, videos and posts on SocioConnect."
    },
    {
      name: "Saved",
      icon: "saved", 
